package org.cc2.parser;

import org.cc2.parser.CCBufferBase;
import java.io.File;
...
public class CCELParser extends CCBufferBase {
    ...
    public final static String else_prfix = "@elseif{";
    ...
    public static void main(String[] args) {
        CCELParser p = new CCELParser(new File("C:\\will\\resources\\template\\mvel\\jsp\\fld_text.htm"), "UTF-8");
        p.test();
    }
}
