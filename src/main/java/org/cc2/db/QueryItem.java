...
public class QueryItem {
    ...
    public static void process_item(ICCDP dp, StringBuffer sb, ICCMap model, ICCMap row, String item) throws Exception {
    ...
    private static void process_op_item(ICCDP dp, StringBuffer sb, ICCMap model, ICCMap row, String[] args) {
        String name = args[0];
    ...
    private static void process_var_item(ICCDP dp, StringBuffer sb, ICCMap model, ICCMap row, String[] args) {
        //    ${field,dt}  |   ${field,dt,alias} 
        String name = args[0];
        String dt = args[1];
        String alias = (args.length > 2) ? args[2] : null;
        ICCType<?> type = dp.types().type(dt);
    ...
    @SuppressWarnings("unchecked")
    private static void process_op2(ICCDP dp, StringBuffer sb, ICCMap model, ICCMap row, String[] args) {
    ...
    @SuppressWarnings("unchecked")
    private static void process_like(ICCDP dp, StringBuffer sb, ICCMap model, ICCMap row, String[] args) {
        String op_name = args[0];
        String name = args[1];
        String dt = args[2];
        String alias = (args.length > 3) ? args[3] : null;
    ...
    @SuppressWarnings("unchecked")
    private static void process_all(ICCDP dp, StringBuffer sb, ICCMap model, ICCMap row, String[] args) {
        String op_name = args[0];
        String name = args[1];
        String dt = args[2];
        String alias = (args.length > 3) ? args[3] : null;
    ...
    @SuppressWarnings("unchecked")
    private static void process_range(ICCDP dp, StringBuffer sb, ICCMap model, ICCMap row, String[] args) {
        String op_name = args[0];
        String name = args[1];
        String dt = args[2];
        String alias = (args.length > 3) ? args[3] : null;
