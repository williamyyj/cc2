...
public class CCCache {
    ...
    public static CCMap load_map(String base, String id, String suffix){
        id = id.replace(".", "/");
        return load_map(new File(base,id+"." + suffix), "UTF-8");
    }
    
    public static CCMap load_map(String base, String fid) {
    ...
    public static CCMap load_map(File f, String enc) {
        ...
        try {
            ...
            CCCacheItem<CCMap> item = (CCCacheItem<CCMap>) cache().get(id);
